...
20. Portfolio ecosystem cycle: periodically repeat discovery across active research/intelligence capability domains, covering repositories, agents, datasets, APIs, benchmarks, labs/institutions, journals, plugins/connectors and validation tooling. Private product implementations and production-web work remain outside the public package unless explicitly sanitized.
